...
<div id="snb">
	...
	<dl>
		...
		<?php } ?>
		<?php echo printMenu1('p20', '가맹점 포인트'); ?>
		...
		<?php echo printMenu1('p20', '가맹점 예치금'); ?>
		<?php echo printMenu2('p20', ADMIN_MENU2_13, TB_ADMIN_URL.'/partner.php?code=cashlist'); ?>
		<?php echo printMenu2('p20', ADMIN_MENU2_14, TB_ADMIN_URL.'/partner.php?code=cashcharge'); ?>
	...
	<dl>
		...
		<?php echo printMenu1('s20', '공급사 예치금'); ?>
		...
		<?php echo printMenu2('s20', ADMIN_MENU3_07, TB_ADMIN_URL.'/seller.php?code=cash_history'); ?>
		<?php echo printMenu2('s20', ADMIN_MENU3_08, TB_ADMIN_URL.'/seller.php?code=cash_charge'); ?>
	</dl>
	<?php }
	...
	<?php }
		...
		$sodr10 = admin_order_status_sum("where dan = 10 "); // 총 구매확정
		$sodrtaxbill = admin_order_status_sum("where taxbill_check = 'N' and taxbill_yes = 'Y' "); // 총 세금계산서 미발급
		$sodrtaxsave = admin_order_status_sum("where taxsave_check = 'N' and taxsave_yes = 'Y' "); // 총 현금영수증 미발급
	...
	<dl>
		...
		<?php echo printMenu2('o10', ADMIN_MENU6_07, TB_ADMIN_URL.'/order.php?code=10', $sodr10['cnt']); ?>
		<?php echo printMenu2('o10', ADMIN_MENU6_14, TB_ADMIN_URL.'/order.php?code=taxbill', $sodrtaxbill['cnt']); ?>
		<?php echo printMenu2('o10', ADMIN_MENU6_15, TB_ADMIN_URL.'/order.php?code=taxsave', $sodrtaxsave['cnt']); ?>
		<?php echo printMenu2('o10', ADMIN_MENU6_08, TB_ADMIN_URL.'/order.php?code=delivery'); ?>
		...
		<?php echo printMenu2('o20', ADMIN_MENU6_11, TB_ADMIN_URL.'/order.php?code=7', $sodr7['cnt']); ?>
		<?php echo printMenu2('o20', ADMIN_MENU6_12, TB_ADMIN_URL.'/order.php?code=8', $sodr8['cnt']); ?>
		<?php echo printMenu1('o30', '기타관리'); ?>
		<?php echo printMenu2('o30', ADMIN_MENU6_13, TB_ADMIN_URL.'/order.php?code=memo', $memoCnt); ?>
	</dl>
	<?php }
	...
	<?php }
		...
		$goodsqaCnt   = admRequest("shop_goods_qa", "and seller_id = '{$seller['seller_code']}'"); // 총 상품문의
	...
	<dl>
		...
		<?php echo printMenu2('h10', ADMIN_MENU8_02, TB_BBS_URL.'/list.php?code=notice&admin=true&boardid=13'); ?>
		<?php echo printMenu2('h10', ADMIN_MENU8_04, TB_ADMIN_URL.'/help.php?code=leave'); ?>
		<?php echo printMenu1('h20', 'FAQ 관리'); ?>
		<?php echo printMenu2('h20', ADMIN_MENU8_05, TB_ADMIN_URL.'/help.php?code=faq_group'); ?>
		<?php echo printMenu2('h20', ADMIN_MENU8_06, TB_ADMIN_URL.'/help.php?code=faq'); ?>
	</dl>
	<?php }
