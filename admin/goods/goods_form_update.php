...
$value['lv2_price']	= conv_number($_POST['goods_price']); //공급가격
$value['lv4_price']	= conv_number($_POST['lv4_price']); //공급가격
$value['lv5_price']	= conv_number($_POST['lv5_price']); //공급가격
$value['lv6_price']	= conv_number($_POST['lv6_price']); //공급가격
$value['lv7_price']	= conv_number($_POST['lv7_price']); //공급가격
$value['lv8_price']	= conv_number($_POST['lv8_price']); //공급가격
$value['lv9_price']	= conv_number($_POST['lv9_price']); //공급가격
