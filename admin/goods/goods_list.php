...
<div class="tbl_head02">
	...
	<tr>
		...
		<th scope="col" colspan="7" class="th_bg">가격정보</th>
	...
	<tr class="rows">
		...
		<!--th scope="col" class="th_bg"><?php echo subject_sort_link('lv1_price',$q2); ?>레벨1판매가</a></th>
		<th scope="col" class="th_bg"><?php echo subject_sort_link('lv2_price',$q2); ?>레벨2판매가</a></th>
		<th scope="col" class="th_bg"><?php echo subject_sort_link('lv3_price',$q2); ?>레벨3판매가</a></th>
		<th scope="col" class="th_bg"><?php echo subject_sort_link('lv4_price',$q2); ?>레벨4판매가</a></th>
		<th scope="col" class="th_bg"><?php echo subject_sort_link('lv5_price',$q2); ?>레벨5판매가</a></th>
		<th scope="col" class="th_bg"><?php echo subject_sort_link('lv6_price',$q2); ?>레벨6판매가</a></th-->

		<th scope="col" class="th_bg"><?php echo subject_sort_link('lv9_price',$q2); ?>일반회원판매가</a></th>
		<th scope="col" class="th_bg"><?php echo subject_sort_link('lv8_price',$q2); ?>우수회원판매가</a></th>
		<th scope="col" class="th_bg"><?php echo subject_sort_link('lv7_price',$q2); ?>특별회원판매가</a></th>

		<th scope="col" class="th_bg"><?php echo subject_sort_link('goods_price',$q2); ?>소매판매가</a></th>
	...
	<tr class="<?php echo $bg; ?>">
		...
		<!--td rowspan="2" class="tar"><?php echo number_format($row['lv1_price']); ?></td>
		<td rowspan="2" class="tar"><?php echo number_format($row['lv2_price']); ?></td>
		<td rowspan="2" class="tar"><?php echo number_format($row['lv3_price']); ?></td>
		<td rowspan="2" class="tar"><?php echo number_format($row['lv4_price']); ?></td>
		<td rowspan="2" class="tar"><?php echo number_format($row['lv5_price']); ?></td>
		<td rowspan="2" class="tar"><?php echo number_format($row['lv6_price']); ?></td-->
		<td rowspan="2" class="tar"><?php echo number_format($row['lv9_price']); ?></td>
		<td rowspan="2" class="tar"><?php echo number_format($row['lv8_price']); ?></td>
		<td rowspan="2" class="tar"><?php echo number_format($row['lv7_price']); ?></td>
