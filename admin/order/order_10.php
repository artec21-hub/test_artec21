...
<div class="tbl_head01">
	...
	<tr class="<?php echo $bg; ?>">
		...
		<td class="td_itname"><a href="<?php echo TB_ADMIN_URL; ?>/goods.php?code=form&w=u&gs_id=<?php echo $row2['gs_id']; ?>" target="_blank"><?php echo $gs['explan']; ?>/<?php echo $gs['model']; ?>/<?php echo get_text($gs['gname']); ?></a></td>
		...
		<td rowspan="<?php echo $rowspan; ?>" class="td_price"><?php echo $row['supply_price']; ?></td>
