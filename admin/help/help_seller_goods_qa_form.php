...
<form name="fregform" method="post" action="./help_seller_goods_qa_form_update.php" autocomplete="off">
...
<div class="btn_confirm">
	...
	<a href="./help.php?code=seller_goods_qa<?php echo $qstr; ?>&page=<?php echo $page; ?>" class="btn_large bx-white">목록</a>
</div>
</form>
