...
$sql_common = " from shop_cash_history a, shop_partner b ";
...
<div class="local_ov01 local_ov mart30">
    ...
    &nbsp;<span class="btn_ov01"><span class="ov_txt"><?php echo $sfl; ?> 님 예치금 잔액 </span><span class="ov_num"> <?php echo number_format($total_remain); ?> 원</span></span>
</div>
...
<div class="tbl_head01">
	...
	<tr class="<?php echo $bg; ?>">
		...
		<td class="tal"><?php echo $row['to_id']; ?></td>
