...
<div class="tbl_head01">
	...
	<tr>
		...
		<th scope="col">예치금충전(월)</th>
		<!--th scope="col">접속수수료(CPC)</th-->
		<th scope="col">월매출(도매+소매)</th>
	</tr>
	</thead>
	<tbody class="list">
	<?php
	$sql = " select * from shop_member_grade where gb_no between 3 and 6 order by gb_no desc ";
	$res = sql_query($sql);
	...
	<tr class="<?php echo $bg; ?>">
		...
		<td>
			<label for="gb_term_price<?php echo $i; ?>" class="sound_only">예치금충전(월)</label>
