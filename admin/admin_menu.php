...
define('ADMIN_MENU2_02',	'가맹점 등급정책');
...
define('ADMIN_MENU2_08',	'가맹점 포인트출금요청');
define('ADMIN_MENU2_09',	'가맹점 포인트내역관리');
define('ADMIN_MENU2_10',	'추천인변경 로그');
define('ADMIN_MENU2_11',	'가맹점 트리구조');
define('ADMIN_MENU2_12',	'가맹점 주문통계');
define('ADMIN_MENU2_13',	'가맹점 예치금내역관리');
define('ADMIN_MENU2_14',	'가맹점 예치금충전관리');
...
define('ADMIN_MENU3_07',	'공급사 예치금내역');
define('ADMIN_MENU3_08',	'공급사 예치금충전');
...
define('ADMIN_MENU6_07',	'구매확정');
define('ADMIN_MENU6_14',	'세금계산서발급');
define('ADMIN_MENU6_15',	'현금영수증발급');

define('ADMIN_MENU6_08',	'엑셀 배송일괄처리');
define('ADMIN_MENU6_09',	'입금전 취소');
define('ADMIN_MENU6_10',	'배송전 환불');
define('ADMIN_MENU6_11',	'배송후 반품');
define('ADMIN_MENU6_12',	'배송후 교환');
define('ADMIN_MENU6_13',	'관리자메모');
...
define('ADMIN_MENU8_02',	'공지사항');
define('ADMIN_MENU8_03',	'갤러리게시판');
define('ADMIN_MENU8_04',	'회원 탈퇴내역');
define('ADMIN_MENU8_05',	'FAQ 분류');
define('ADMIN_MENU8_06',	'FAQ 관리');
