...
<div class="tbl_head01">
	...
	<tr>
		<th scope="col">번호</th>
		<th scope="col"><?php echo subject_sort_link('gubun',$q2); ?>회원구분</a></th>
		...
		<th scope="col"><?php echo subject_sort_link('ship_id',$q2); ?>쇼핑몰ID</a></th>
		<th scope="col"><?php echo subject_sort_link('email',$q2); ?>이메일</a></th>
		<th scope="col"><?php echo subject_sort_link('pt_id',$q2); ?>추천인</a></th>
		<th scope="col">핸드폰</th>
		<th scope="col"><?php echo subject_sort_link('today_login',$q2); ?>최근접속일</a></th>
		...
		<?php } ?>
		<th scope="col"><?php echo subject_sort_link('cash',$q2); ?>예치금</a></th>
	...
	<tr class="<?php echo $bg; ?>">
		...
		<?php 
				...
				echo get_sideview($row['id'], $row['name']); 
			
		?></td>
		<td class="tal"><?php echo $row['id']; ?></td>
		<td><?php echo get_grade($row['grade']); ?></td>
		<td class="tal"><?php echo $row['shop_id']; ?></td>
		<td class="tal">
		<?php 
		...
		<?php 
				...
				echo replace_tel($row['cellphone']); 
			
		?>
		</td>
		<td><?php echo $row['today_login']; ?></td>
