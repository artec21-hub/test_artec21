...
<div class="tbl_frm01">
	...
	<tr>
		...
		<td>
			<?php echo radio_checked('taxsave_check', $taxsave_check,  '', '전체'); ?>
			<?php echo radio_checked('taxsave_check', $taxsave_check, 'Y', '발급완료'); ?>
			<?php echo radio_checked('taxsave_check', $taxsave_check, 'N', '미발급'); ?>
		</td>
	</tr>
	</tbody>
	</table>
...
<div class="tbl_head01">
	...
	<tr>
		...
		<th scope="col">현금영수증신청(휴대폰)</th>
		<th scope="col">현금영수증신청(사업자번호)</th>
		<th scope="col">현금영수증발급여부</th>
	</tr>
	</thead>
	<tbody>
	<?php
	...
	for($i=0; $row=sql_fetch_array($result); $i++) {
		...
		if($row['taxsave_check'] == 'N')
			$taxsave_final = '<span class="fc_107">미발급</span>';
		else
			$taxsave_final = '<span class="fc_00f">발급완료</span>';
	...
	<tr class="<?php echo $bg; ?>">
		...
		<td rowspan="<?php echo $rowspan; ?>"><?php echo $row['tax_hp']; ?></td>
		<td rowspan="<?php echo $rowspan; ?>"><?php echo $row['tax_saupja_no']; ?></td>

		<td rowspan="<?php echo $rowspan; ?>"><?php echo $taxsave_final; ?></td>
...
<div class="tbl_frm01">
	...
	<tbody>
	<tr>
		<th scope="row">선택한 현금영수증을</th>
		<td>
			<input type="submit" name="act_button" value="현금영수증발급완료" class="btn_medium red" onclick="document.pressed=this.value">
...
function forderlist_submit(f)
{
    ...
    if(!confirm("선택하신 현금영수증의 상태를 '"+document.pressed+"'상태로 변경하시겠습니까?"))
        return false;
