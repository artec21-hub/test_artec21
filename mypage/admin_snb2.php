...
$sql_where = " where shop_id = '{$member['id']}' ";
...
$sodr10 = admin_order_status_sum("{$sql_where} and dan = 10 "); // 총 구매확정
$sodrtaxbill = admin_order_status_sum("{$sql_where} and taxbill_check = 'N' and taxbill_yes = 'Y' "); // 총 세금계산서 미발급
$sodrtaxsave = admin_order_status_sum("{$sql_where} and taxsave_check = 'N' and taxsave_yes = 'Y' "); // 총 현금영수증 미발급
unset($sql_where);
?>
...
<dl>
	...
	<?php echo printMenu1(5, '상품관리'); ?>
	<?php echo printMenu2(5, '상품목록', asideUrl.'?code=partner_goods_admlist'); ?>
	<?php echo printMenu2(5, '상품판매실적', asideUrl.'?code=partner_order_admlist'); ?>
	...
	<?php echo printMenu2(7, '구매확정', asideUrl.'?code=partner_odr_10', $sodr10['cnt']); ?>
	...
	<?php echo printMenu1(10, '세금계산서/현금영수증 관리'); ?>
	<?php echo printMenu2(10, '세금계산서', asideUrl.'?code=partner_odr_taxbill', $sodrtaxbill['cnt']); ?>
	<?php echo printMenu2(10, '현금영수증', asideUrl.'?code=partner_odr_taxsave', $sodrtaxsave['cnt']); ?>

	<?php echo printMenu1(9, '포인트&예치금'); ?>
	<?php echo printMenu2(9, '본사 공지사항', boardUrl.'?boardid=22'); ?>
	<?php echo printMenu2(9, '포인트 출금관리', asideUrl.'?code=partner_paylist'); ?>
	<?php echo printMenu2(9, '포인트 내역관리', asideUrl.'?code=partner_payhistory'); ?>
	<?php echo printMenu2(9, '도매 예치금내역', asideUrl.'?code=partner_cashhistory'); ?>
	<?php echo printMenu2(9, '도매 예치금충전', asideUrl.'?code=partner_cashcharge'); ?>
