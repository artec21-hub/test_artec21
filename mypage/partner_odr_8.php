...
<div class="tbl_head01">
	...
	<tr class="<?php echo $bg; ?>">
		...
		<td class="td_itname"><a href="<?php echo TB_MYPAGE_URL; ?>/page.php?code=partner_goods_form&w=u&gs_id=<?php echo $row2['gs_id']; ?>" target="_blank"><?php echo $gs['explan']; ?>/<?php echo $gs['model']; ?>/<?php echo get_text($gs['gname']); ?></a></td>
		<?php if($k == 0) { ?>
		<td rowspan="<?php echo $rowspan; ?>">
