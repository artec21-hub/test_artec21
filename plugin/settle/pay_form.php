...
<div class="wrapper" style="margin-top:50px;">  
	<form id="STPG_payForm2" name="STPG_payForm2" >
		<div class="tab">휴대폰 자동 연장 결제 (2회차)</div>
		...
		<input type="hidden" name="mchtTrdNo" value="" />					<!-- 상점주문번호 -->
		<input type="hidden" name="trdDt" value="" />						<!-- 요청일자 -->
		<input type="hidden" name="trdTm" value="" />						<!-- 요청시간 -->
		...
		<table>
			<tr>
				<td class="left">거래금액</td>
				<td class="right"><input type="text" name="trdAmt" maxlength="9" value="1000" /><span>* 필수 *</span></td>
			</tr>
			<tr style="background-color:yellow;">
				<td class="left">자동결제키</td>
				<td class="right"><input type="text" name="billKey" maxlength="50" value="" /><span>* 필수 *</span></td>
			</tr>
			<tr>
				<td colspan="2" class="right" style="text-align: center;"><input class="payBtn" type="button" value="결제 하기" onclick="autoPay()"/></td>
			</tr>
		</table>
