...
//AES256 복호화 필요 파라미터
$DECRYPT_PARAMS = array("cnclAmt","cardCnclAmt","pntCnclAmt", "blcAmt", "vAcntNo");
...
$hashCipher ="";
try{
	if( $REQ_HEADER["method"] === "VA1" ){//가상계좌 채번 취소
...
/** ======================================================================
 * 							타겟 URL 설정
 *  타겟 서버 : gw.settlebank.co.kr
 *  공통 취소 : ~/spay/APICancel.do 
 *  가상계좌 채번취소 : ~/spay/APIVBank.do
 *  가상계좌 환불 : ~/spay/APIRefund.do
 *  ======================================================================   */
$requestUrl = "";
if( "VA1" === $REQ_HEADER["method"] ){ 
	$requestUrl = $cnclServer."/spay/APIVBank.do";
	$REQ_HEADER["method"] = "VA";
}else if( "VA2" === $REQ_HEADER["method"] ){
