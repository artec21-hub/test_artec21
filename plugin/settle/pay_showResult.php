...
<div class="wrapper">
	...
	<table>
		...
		<tr>
			<td class="left">RtNowDiscountAmt[즉시할인금액]</td>
			<td class="right"><?php echo $RtNowDiscountAmt ?></td>
		</tr>
		<tr>
			<td class="left">AlacDiscountAmt[제휴할인금액]</td>
			<td class="right"><?php echo $AlacDiscountAmt ?></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td class="right"><?php echo $vAcntNo ?></td>
		</tr>
		<tr>
