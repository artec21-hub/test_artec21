...
<div class="tbl_head01 tbl_wrap2 mart30">
	<table>
	<colgroup>
		<col width="50">
		<col>
	...
	for($i=0; $row=sql_fetch_array($rst); $i++) {
		...
		$bo_href = './read.php?code=notice&admin=true&index_no='.$row['index_no'].'&'.$qstr1;
	?>
	<tr>
...
<div class="tbl_frm01 tbl_wrap mart30">
	...
	if(sql_num_rows($res)) {
		...
		$prev_href = "./read.php?code=notice&admin=true&index_no=$prev_no&boardid=$boardid$qstr&page=$page";
	?>
	<tr>
		<th width="15%">▲ 이전 글</th>
	...
	if(sql_num_rows($res)) {
		...
		$next_href = "./read.php?code=notice&admin=true&index_no=$next_no&boardid=$boardid$qstr&page=$page";
	?>
	<tr>
		<th width="15%">▼ 다음 글</th>
