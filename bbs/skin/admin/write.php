...
<form name="fboardform" id="fboardform" method="post" action="http://casefarm.kr/bbs/admin_write_update.php" onsubmit="return fboardform_submit(this);" autocomplete="off" enctype="MULTIPART/FORM-DATA">
