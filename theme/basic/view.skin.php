...
<div class="vi_info">
	...
	<div class="vi_txt_bx">
		<h2 class="tit">
			<span class="gName"><?php echo $gs['explan']; ?></span> <span class="bar"> </span> <span class="pName"><?php echo $gs['model']; ?></span> <br>
			<span class="mName"><?php echo $gs['brand_nm']; ?></span> <span class="bName"><?php echo $gs['gname']; ?></span>
			...
			<ul id="option_set_added">
				<li class="sit_opt_list vi_txt_li">
					<dl>
						...
						<input type="hidden" class="t_idx" value="0">
						<input type="hidden" class="king_pcode[<?php echo $index_no; ?>][]" value="">
						<dt>
