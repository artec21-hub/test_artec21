...
<form name="fbuyform" method="post">
    ...
    <div class="sub_list_btn_ct">
        <ul>
            ...
            <li>
                <!--선택상품 총합계 : <span id="list_total_price" class="bd">0</span> 원-->
            </li>
        </ul>
    </div>
    <div class="tab_sort">
                    ...
                    <li>
                        <dd class="price2 v1">
                            <a href="<?php echo $it_href; ?>">
                                <span class="gName_v1"><?php echo $it_explan; ?></span>
                                <span class="bar_v1"></span>
                                <span class="pName_v1"><?php echo $it_model; ?></span><br>
                                <span class="bName_v1"><?php echo $it_brand; ?></span>
                                <span class="Mname_v1"><?php echo $it_name; ?></span>
                            </a>
                            <br>
                            <a href="<?php echo $it_href; ?>">
                                <?php echo $it_sprice; ?><?php echo $it_price; ?>
                            </a>
                        </dd>
                    </li>
                            ...
                            <ul class="option_set_added">
                                <li class="sit_opt_list2 vi_txt_li4">
                                    <dl>
                                        ...
                                        <input type="hidden" class="io_stock" value="<?php echo $stock; ?>">
                                        <input type="hidden" class="t_idx" value="<?php echo $t_idx; ?>">
                                        <input type="hidden" class="king_pcode[<?php echo $row['index_no']; ?>][]" value="">
                                        <?php $t_idx = $t_idx + 1; ?>
                                        <dt>
                                        ...
                                        <dd class="li_ea button_etc">
                                            ...
                                            <span class="marl7">(재고수량 : <?php echo $row['stock_mod'] ? display_qty($stock) : '무제한'; ?>)</span>
                                        </dd>
                                    </dl>
                                </li>
                            </ul>
