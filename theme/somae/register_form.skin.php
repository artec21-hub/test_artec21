...
<input type="hidden" name="mb_recommend" id="reg_mb_recommend" value="<?php echo $shop_pt_id; ?>">
...
<div class="tbl_company">
	...
	<div class="tbl_frm01 tbl_wrap">
		...
		<tr>
			...
			<td><input type="text" onkeypress='return checkNumber(event)' name="company_saupja_no" id="reg_company_saupja_no"  itemname="사업자등록번호" required class="required frm_input" size="30" placeholder="예) 123-45-67890" value="<?php echo get_text($member['company_saupja_no']); ?>"><!--a href="javascript:saupjaonopen('<?php echo conv_number($config['company_saupja_no']); ?>');" class="btn_ssmall grey2 marl5">사업자정보확인</a--></td>
		</tr>
		<tr>
