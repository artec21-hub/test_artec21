...
<div class="cont_wrap mart60">
	...
	<?php echo get_listtype_skin("3", '500', '500', '10', 'wli4 mart5'); ?>	
</div>
<!-- } 신상품 끝 -->
<!-- 베스트상품 시작 {-->
<div class="cont_wrap mart50">
	<div class="bst_img"><p align="right"><img class="hard" src="/img/hard_w.png" width="178px"><img class="soft" src="/img/soft_b.png" width="178px"><img class="diary" src="/img/diary_b.png" width="178px"><img class="accessroy" src="/img/accessroy_b.png" width="178px"></p></div>
